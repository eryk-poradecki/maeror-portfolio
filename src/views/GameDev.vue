<template>
  <div class="flex flex-col items-center">
    <div class="header my-2 text-4xl md:text-7xl font-bold text-neutral-200">Game Dev</div>
  </div>

  <div v-for="category in categories" :key="category">
    <template v-if="hasProjectsInCategory(category)">
      <h1 class="text-xl md:text-4xl font-normal text-center text-neutral-200">
...
const handleTileClick = (project) => {
  if (project.categories.every(cat => noPopupCategories.includes(cat))) {
